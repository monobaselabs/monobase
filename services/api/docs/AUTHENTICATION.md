...
**Implementation note**: The API service reads the Better-Auth database tables directly and performs HMAC-SHA256 signature verification natively using the `hmac`, `sha2`, and `base64` crates.
